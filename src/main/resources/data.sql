...
VALUES ('module 1', 'description 1', 'code 1', 1),
       ('module 2', 'description 2', 'code 2', 1),
       ('module 3', 'description 3', 'code 3', 1),
       ('module 4', 'description 4', 'code 4', 1),
       ('module 5', 'description 5', 'code 5', 1),
       ('module 6', 'description 6', 'code 6', 1),
       ('module 7', 'description 7', 'code 7', 1),
       ('module 8', 'description 8', 'code 8', 1),
       ('module 9', 'description 9', 'code 9', 1),
       ('module 10', 'description 10', 'code 10', 1);